...
#' @description This function draws the values to draw the original visual predictive check plot
#' which is proposed by Holford & Karlsson (2008). 
...
#' data(origdata)
#' data(simdata)
#' VPCgraph(origdata,simdata,type="CI",X_name="TIME",Y_name="DV")
#' }
